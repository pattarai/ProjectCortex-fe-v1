...
export function CompleteProfile(props: Props) {
  ...
  const [fileSelected, setFileSelected] = React.useState(''); // also tried <string | Blob>
                      ...
                      <Box sx={{ '& > :not(style)': { m: 1 } }}>
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <MenuItem value={20}>Innovation and Media</MenuItem>
                            <MenuItem value={20}>Human Resource</MenuItem>
                            <MenuItem value={20}>Business Development</MenuItem>
                          </Select>
                        </FormControl>
                      </Box>
                    </div>
